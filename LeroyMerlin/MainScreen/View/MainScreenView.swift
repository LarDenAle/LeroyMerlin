...
// Осталась проблема с разделителями в TabMain между CatalogView ContentLimitedOfferView ContentBestPriceView - решения для IOS 13 есть но тут не срабатывают
